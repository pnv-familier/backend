        ...
        switch (suggestionType) {
            case "EVENT":
                sb.append("\n- MỤC TIÊU: Tạo lịch hẹn (Dù thiếu giờ vẫn detect nếu rõ ý định).")
                        ...
                        .append("\n- CHIẾN THUẬT: ")
                        .append("\n  + Nếu thiếu giờ: Để startTime/endTime ngoài giờ làm việc.")
                        .append("\n  + Nếu có 1 mốc giờ: endTime = startTime + 1h.")
                        .append("\n  + Tính ngày: 'Mai'=+1, 'Mốt'=+2, 'Cuối tuần'=Thứ 7 hoặc Chủ nhật tuần này. Dựa trên mốc: ")
                        .append(dateRef)
            ...
            case "OFFLINE":
                sb.append("\n- MỤC TIÊU: Chuyển đổi trạng thái tiêu cực/xa cách thành hành động kết nối vật lý.")
                        ...
                        .append("\n- YÊU CẦU ACTION:")
                        .append("\n  + Phải là hành động kết nối gia đình (Ăn cơm, đi dạo, tặng quà trực tiếp, ôm, trò chuyện, gọi cho mẹ).")
                        .append("\n  + JSON: { \"action\": str }")
                        .append("\n  + Action: Nếu không có, để là: \"Hỏi thăm người thân đang như thế nào\".")
